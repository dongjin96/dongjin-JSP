...
<body>
	...
	<div class="container">
		...
		<a href="api.jsp"><button>백신접종</button></a>
	
		<h3>제품목록</h3>
		<table class="table">
			<tr>
				<th>제품번호</th> <th>제품명</th> <th>제품가격</th> <th>카테고리</th>
				<th>상태</th> <th>사이즈</th> <th>재고</th> <th>제품등록일</th>
			</tr>
			...
			<tr>
				...
				<td>
					<a href="../board/boardupdate.jsp"><button class="btn-outline-info">수정</button></a>
